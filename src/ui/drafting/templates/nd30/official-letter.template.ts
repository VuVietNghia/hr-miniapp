...
export const officialLetterTemplate: DraftingTemplate = {
  id: 'official-letter',
  title: 'Thư công (Official Letter)',
  category: 'thongtin',
  categoryLabel: 'Thông tin & Giao tiếp',
  track: 'nd30_administrative',
  icon: '📄',
  description: 'Mẫu Thư công (Official Letter) chuẩn thể thức Nghị định 30/2020/NĐ-CP.',
  defaultData: {
