...
export const projectSchemeTemplate: DraftingTemplate = {
  id: 'project-scheme',
  title: 'Đề án (Project Scheme)',
  category: 'kehoach',
  categoryLabel: 'Kế hoạch & Báo cáo',
  track: 'nd30_administrative',
  icon: '📄',
  description: 'Mẫu Đề án (Project Scheme) chuẩn thể thức Nghị định 30/2020/NĐ-CP.',
  defaultData: {
