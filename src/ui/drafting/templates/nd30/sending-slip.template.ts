...
export const sendingSlipTemplate: DraftingTemplate = {
  id: 'sending-slip',
  title: 'Phiếu gửi (Sending Slip)',
  category: 'phutro',
  categoryLabel: 'Biểu mẫu Phụ trợ',
  track: 'nd30_administrative',
  icon: '📄',
  description: 'Mẫu Phiếu gửi (Sending Slip) chuẩn thể thức Nghị định 30/2020/NĐ-CP.',
  defaultData: {
